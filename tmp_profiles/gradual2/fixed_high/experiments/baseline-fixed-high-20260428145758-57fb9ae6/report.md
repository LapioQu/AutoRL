...
| Field | Value |
| --- | --- |
| Experiment ID | baseline-fixed-high-20260428145758-57fb9ae6 |
| Experiment Name | baseline-fixed_high |
| Status | completed |
| Scenario | gradual_drift |
| Seed | 52 |
| Config Hash | 2b08b868a73b2af64838dd8c0835ce6b9a1e1bb8dfb73ac4a1ea6f7da47c6f24 |
| Artifacts Path | `tmp_profiles\gradual2\fixed_high\experiments\baseline-fixed-high-20260428145758-57fb9ae6` |
...
| Average Reward | 0.718555 |
| Success Rate | 0.522222 |
| Cumulative Reward | 64.669961 |
| Mean Window Variance | 0.000563 |
...
meta_controller:
  ...
  utility_weights:
    ...
    compute_cost: 0.08
    switch_cost: 0.2
artifacts_root: tmp_profiles/gradual2/fixed_high
tags: []
notes: null
```
