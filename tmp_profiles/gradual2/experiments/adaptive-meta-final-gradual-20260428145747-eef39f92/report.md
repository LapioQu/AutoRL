...
| Field | Value |
| --- | --- |
| Experiment ID | adaptive-meta-final-gradual-20260428145747-eef39f92 |
| Experiment Name | adaptive-meta-final-gradual |
| Status | completed |
| Scenario | gradual_drift |
| Seed | 52 |
| Config Hash | 3e68925d8723f8c770d6323e0fc8e161f45eb2f2f9a653cd29021412ffcfa843 |
| Artifacts Path | `tmp_profiles\gradual2\experiments\adaptive-meta-final-gradual-20260428145747-eef39f92` |
...
| Average Reward | 1.043293 |
| Success Rate | 1.000000 |
| Cumulative Reward | 93.896392 |
| Mean Window Variance | 0.001489 |
...
| 4 | switch | fixed_low | fixed_mid | 0.058934 | 0.020000 | switch_advantage |
| 5 | stay | fixed_mid | adaptive_meta_final | -0.007821 | 0.020000 | no_candidate_improvement |
| 6 | stay | fixed_mid | adaptive_meta_final | -0.007621 | 0.020000 | no_candidate_improvement |
...
```yaml
schema_version: '1.0'
experiment_name: adaptive-meta-final-gradual
seed: 52
mode: adaptive
scenario:
  name: gradual_drift
...
meta_controller:
  ...
  utility_weights:
    ...
    compute_cost: 0.08
    switch_cost: 0.2
artifacts_root: tmp_profiles/gradual2
tags: []
notes: null
```
