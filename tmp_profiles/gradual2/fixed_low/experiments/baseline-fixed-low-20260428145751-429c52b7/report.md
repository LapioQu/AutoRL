...
| Field | Value |
| --- | --- |
| Experiment ID | baseline-fixed-low-20260428145751-429c52b7 |
| Experiment Name | baseline-fixed_low |
| Status | completed |
| Scenario | gradual_drift |
| Seed | 52 |
| Config Hash | ad7193064efc597af0925f99444d46b937e040e80e487d0785b2610051b9a366 |
| Artifacts Path | `tmp_profiles\gradual2\fixed_low\experiments\baseline-fixed-low-20260428145751-429c52b7` |
...
| Average Reward | 0.747248 |
| Success Rate | 0.544444 |
| Cumulative Reward | 67.252292 |
| Mean Window Variance | 0.000600 |
...
meta_controller:
  ...
  utility_weights:
    ...
    compute_cost: 0.08
    switch_cost: 0.2
artifacts_root: tmp_profiles/gradual2/fixed_low
tags: []
notes: null
```
