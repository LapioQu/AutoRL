...
- created_at_utc: `2026-04-29T11:33:03.602466+00:00`
- dataset_name: `Bikes`
...
- adaptive_score: `0.669857`
- best_fixed_strategy: `sgd_lr_0_0001`
- best_fixed_score: `0.669679`
- delta_vs_best_fixed: `+0.000178`
- oracle_score: `0.672902`
- oracle_gain: `0.003223`
- oracle_capture_ratio: `5.52%`
- final_strategy: `sgd_lr_0_0001`
- switch_count: `1`

## Interpretation

- Adaptive policy `hard_switch_lcb` finished on strategy `sgd_lr_0_0001` after 1 switches.
- It achieved `0.6699` against the best fixed baseline `sgd_lr_0_0001` at `0.6697`.
- Oracle upper bound on this stream is `0.6729`. Available oracle gain over best fixed is `0.0032`, and the current adaptive controller captures `5.5%` of it.
- The uploaded stream looks non-stationary enough for adaptation to help: the gain over best fixed is `0.0002`.
...
- artifact_root: `artifacts\runtime_diagnosis\hard_switch_lcb\dataset_lab\bikes-20260429112642`
- replay_summary_json_path: `E:\dipproj\artifacts\runtime_diagnosis\hard_switch_lcb\dataset_lab\bikes-20260429112642\summary.json`
- decision_csv_path: `E:\dipproj\artifacts\runtime_diagnosis\hard_switch_lcb\dataset_lab\bikes-20260429112642\decisions.csv`
- replay_report_md_path: `E:\dipproj\artifacts\runtime_diagnosis\hard_switch_lcb\dataset_lab\bikes-20260429112642\summary.md`
