...
- created_at_utc: `2026-04-29T12:21:56.727228+00:00`
- dataset_name: `Elec2`
...
- adaptive_score: `0.914085`
- best_fixed_strategy: `pa_classifier`
- best_fixed_score: `0.922714`
- delta_vs_best_fixed: `-0.008629`
- oracle_score: `0.979123`
- oracle_gain: `0.056409`
...
- Adaptive policy `fixed_share_portfolio` finished on strategy `pa_classifier` after 325 switches.
- It achieved `0.9141` against the best fixed baseline `pa_classifier` at `0.9227`.
- Oracle upper bound on this stream is `0.9791`. Available oracle gain over best fixed is `0.0564`, and the current adaptive controller captures `0.0%` of it.
- The current stationary portfolio dominated the adaptive controller here; the gap is `-0.0086`.
...
- score_plot_path: `artifacts\debug_elec2_fixedshare\dataset_lab\elec2-20260429122135\dataset_lab_scores.png`
- portfolio_plot_path: `artifacts\debug_elec2_fixedshare\dataset_lab\elec2-20260429122135\dataset_lab_portfolio.png`
- switch_plot_path: `artifacts\debug_elec2_fixedshare\dataset_lab\elec2-20260429122135\dataset_lab_switches.png`

## Artifact Paths

- artifact_root: `artifacts\debug_elec2_fixedshare\dataset_lab\elec2-20260429122135`
- replay_summary_json_path: `E:\dipproj\artifacts\debug_elec2_fixedshare\dataset_lab\elec2-20260429122135\summary.json`
- decision_csv_path: `E:\dipproj\artifacts\debug_elec2_fixedshare\dataset_lab\elec2-20260429122135\decisions.csv`
- replay_report_md_path: `E:\dipproj\artifacts\debug_elec2_fixedshare\dataset_lab\elec2-20260429122135\summary.md`
