...
| Field | Value |
| --- | --- |
| Experiment ID | abrupt-drift-seed-45-20260430052600-07050bef |
| Experiment Name | abrupt_drift-seed-45 |
| Status | completed |
| Scenario | abrupt_drift |
| Seed | 45 |
| Config Hash | 61f9def98a7a7643df6c399edbd13d0da53fc1c50c6ef217593dbe9df3a0d529 |
| Artifacts Path | `E:\dipproj\artifacts\phase10_experimental_series\e2_abrupt-drift\seed_45\experiments\abrupt-drift-seed-45-20260430052600-07050bef` |
...
| Average Reward | 0.973723 |
| Success Rate | 0.913333 |
| Cumulative Reward | 146.058480 |
| Mean Window Variance | 0.014879 |
...
| 11 | stay | greedy_reward | drift_aware | -0.134728 | 0.260000 | no_candidate_improvement |
...
```yaml
schema_version: '1.0'
experiment_name: abrupt_drift-seed-45
seed: 45
mode: adaptive
scenario:
  name: abrupt_drift
...
meta_controller:
  ...
  utility_weights:
    ...
    switch_cost: 0.6
artifacts_root: E:\dipproj\artifacts\phase10_experimental_series\e2_abrupt-drift\seed_45
tags:
- phase1
- abrupt_drift
notes: null
