...
| Field | Value |
| --- | --- |
| Experiment ID | abrupt-drift-seed-41-20260430052543-2d29946c |
| Experiment Name | abrupt_drift-seed-41 |
| Status | completed |
| Scenario | abrupt_drift |
| Seed | 41 |
| Config Hash | bf50e7caea71aea8db3174ad129ca220a106a3f39b45357ce691a31305c921f3 |
| Artifacts Path | `E:\dipproj\artifacts\phase10_experimental_series\e2_abrupt-drift\seed_41\experiments\abrupt-drift-seed-41-20260430052543-2d29946c` |
...
| Average Reward | 0.973878 |
| Success Rate | 0.913333 |
| Cumulative Reward | 146.081756 |
| Mean Window Variance | 0.014920 |
...
```yaml
schema_version: '1.0'
experiment_name: abrupt_drift-seed-41
seed: 41
mode: adaptive
scenario:
  name: abrupt_drift
...
meta_controller:
  ...
  utility_weights:
    ...
    switch_cost: 0.6
artifacts_root: E:\dipproj\artifacts\phase10_experimental_series\e2_abrupt-drift\seed_41
tags:
- phase1
- abrupt_drift
notes: null
