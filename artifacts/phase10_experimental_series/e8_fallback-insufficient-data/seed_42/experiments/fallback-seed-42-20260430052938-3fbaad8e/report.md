...
| Field | Value |
| --- | --- |
| Experiment ID | fallback-seed-42-20260430052938-3fbaad8e |
| Experiment Name | fallback-seed-42 |
| Status | completed |
| Scenario | fallback |
| Seed | 42 |
| Config Hash | 389887e8523c604ecab8ec72c67a1d11c9716677e24b55849875fca0fb842f5c |
| Artifacts Path | `E:\dipproj\artifacts\phase10_experimental_series\e8_fallback-insufficient-data\seed_42\experiments\fallback-seed-42-20260430052938-3fbaad8e` |
...
| Average Reward | 1.137938 |
| Success Rate | 1.000000 |
| Cumulative Reward | 113.793812 |
...
```yaml
schema_version: '1.0'
experiment_name: fallback-seed-42
seed: 42
mode: adaptive
scenario:
  name: fallback
...
meta_controller:
  ...
  utility_weights:
    ...
    reward_variance: 0.2
    switch_cost: 0.5
artifacts_root: E:\dipproj\artifacts\phase10_experimental_series\e8_fallback-insufficient-data\seed_42
tags:
- phase1
- fallback
notes: null
