...
| Field | Value |
| --- | --- |
| Experiment ID | fallback-seed-45-20260430052950-d3186a69 |
| Experiment Name | fallback-seed-45 |
| Status | completed |
| Scenario | fallback |
| Seed | 45 |
| Config Hash | bfc65e8a40520f4ab9d453f4a27fd8dd7e709651222bafc64e77deda46038f0f |
| Artifacts Path | `E:\dipproj\artifacts\phase10_experimental_series\e8_fallback-insufficient-data\seed_45\experiments\fallback-seed-45-20260430052950-d3186a69` |
...
| Average Reward | 1.137794 |
| Success Rate | 1.000000 |
| Cumulative Reward | 113.779350 |
...
```yaml
schema_version: '1.0'
experiment_name: fallback-seed-45
seed: 45
mode: adaptive
scenario:
  name: fallback
...
meta_controller:
  ...
  utility_weights:
    ...
    reward_variance: 0.2
    switch_cost: 0.5
artifacts_root: E:\dipproj\artifacts\phase10_experimental_series\e8_fallback-insufficient-data\seed_45
tags:
- phase1
- fallback
notes: null
