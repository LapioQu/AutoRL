...
| Field | Value |
| --- | --- |
| Experiment ID | fallback-seed-43-20260430080818-4c5240cf |
| Experiment Name | fallback-seed-43 |
| Status | completed |
| Scenario | fallback |
| Seed | 43 |
| Config Hash | 7acfd16a55bff9f6cbdf32eccdd95ba0be23ef40c538c67b6289dbf20bd9967a |
| Artifacts Path | `E:\dipproj\artifacts\phase10_experimental_series\e8_fallback-insufficient-data\seed_43\experiments\fallback-seed-43-20260430080818-4c5240cf` |
...
| Average Reward | 1.137417 |
| Success Rate | 1.000000 |
| Cumulative Reward | 113.741736 |
| Mean Window Variance | 0.000032 |
...
```yaml
schema_version: '1.0'
experiment_name: fallback-seed-43
seed: 43
mode: adaptive
scenario:
  name: fallback
...
meta_controller:
  ...
  utility_weights:
    ...
    reward_variance: 0.2
    switch_cost: 0.5
artifacts_root: E:\dipproj\artifacts\phase10_experimental_series\e8_fallback-insufficient-data\seed_43
tags:
- phase1
- fallback
notes: null
