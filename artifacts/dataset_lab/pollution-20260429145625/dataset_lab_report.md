...
- created_at_utc: `2026-04-29T14:56:42.906013+00:00`
...
- adaptive_score: `0.839626`
- best_fixed_strategy: `lin_lr_0_002`
- best_fixed_score: `0.838480`
- delta_vs_best_fixed: `+0.001146`
- oracle_score: `0.904527`
- oracle_gain: `0.066047`
- oracle_capture_ratio: `1.73%`
- final_strategy: `lin_lr_0_002`
- switch_count: `20`

## Interpretation

- Adaptive policy `fixed_share_portfolio` finished on strategy `lin_lr_0_002` after 20 switches.
- It achieved `0.8396` against the best fixed baseline `lin_lr_0_002` at `0.8385`.
- Oracle upper bound on this stream is `0.9045`. Available oracle gain over best fixed is `0.0660`, and the current adaptive controller captures `1.7%` of it.
- The uploaded stream looks non-stationary enough for adaptation to help: the gain over best fixed is `0.0011`.
...
- score_plot_path: `artifacts\dataset_lab\pollution-20260429145625\dataset_lab_scores.png`
- portfolio_plot_path: `artifacts\dataset_lab\pollution-20260429145625\dataset_lab_portfolio.png`
- switch_plot_path: `artifacts\dataset_lab\pollution-20260429145625\dataset_lab_switches.png`

## Artifact Paths

- artifact_root: `artifacts\dataset_lab\pollution-20260429145625`
- replay_summary_json_path: `E:\dipproj\artifacts\dataset_lab\pollution-20260429145625\auto_meta_selection\fixed_share_portfolio\summary.json`
- decision_csv_path: `E:\dipproj\artifacts\dataset_lab\pollution-20260429145625\auto_meta_selection\fixed_share_portfolio\decisions.csv`
- replay_report_md_path: `E:\dipproj\artifacts\dataset_lab\pollution-20260429145625\auto_meta_selection\fixed_share_portfolio\summary.md`
