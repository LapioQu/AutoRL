...
- created_at_utc: `2026-04-29T14:56:19.801960+00:00`
- dataset_name: `Elec2`
...
- Adaptive policy `best_fixed_guard` finished on strategy `softmax_lr_0_20` after 0 switches.
- It achieved `0.8812` against the best fixed baseline `softmax_lr_0_20` at `0.8812`.
- Oracle upper bound on this stream is `0.9650`. Available oracle gain over best fixed is `0.0837`, and the current adaptive controller captures `0.0%` of it.
...
- score_plot_path: `artifacts\dataset_lab\elec2-20260429145609\dataset_lab_scores.png`
- portfolio_plot_path: `artifacts\dataset_lab\elec2-20260429145609\dataset_lab_portfolio.png`
- switch_plot_path: `artifacts\dataset_lab\elec2-20260429145609\dataset_lab_switches.png`

## Artifact Paths

- artifact_root: `artifacts\dataset_lab\elec2-20260429145609`
- replay_summary_json_path: `E:\dipproj\artifacts\dataset_lab\elec2-20260429145609\summary.json`
- decision_csv_path: `E:\dipproj\artifacts\dataset_lab\elec2-20260429145609\decisions.csv`
- replay_report_md_path: `E:\dipproj\artifacts\dataset_lab\elec2-20260429145609\summary.md`
