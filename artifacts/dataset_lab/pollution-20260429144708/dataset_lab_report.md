...
- created_at_utc: `2026-04-29T14:47:26.448044+00:00`
...
- adaptive_score: `0.839153`
- best_fixed_strategy: `lin_lr_0_002`
- best_fixed_score: `0.838480`
- delta_vs_best_fixed: `+0.000672`
- oracle_score: `0.905094`
- oracle_gain: `0.066614`
- oracle_capture_ratio: `1.01%`
- final_strategy: `lin_lr_0_002`
- switch_count: `3`

## Interpretation

- Adaptive policy `hard_switch_lcb` finished on strategy `lin_lr_0_002` after 3 switches.
- It achieved `0.8392` against the best fixed baseline `lin_lr_0_002` at `0.8385`.
- Oracle upper bound on this stream is `0.9051`. Available oracle gain over best fixed is `0.0666`, and the current adaptive controller captures `1.0%` of it.
- The uploaded stream looks non-stationary enough for adaptation to help: the gain over best fixed is `0.0007`.
...
- score_plot_path: `artifacts\dataset_lab\pollution-20260429144708\dataset_lab_scores.png`
- portfolio_plot_path: `artifacts\dataset_lab\pollution-20260429144708\dataset_lab_portfolio.png`
- switch_plot_path: `artifacts\dataset_lab\pollution-20260429144708\dataset_lab_switches.png`

## Artifact Paths

- artifact_root: `artifacts\dataset_lab\pollution-20260429144708`
- replay_summary_json_path: `E:\dipproj\artifacts\dataset_lab\pollution-20260429144708\summary.json`
- decision_csv_path: `E:\dipproj\artifacts\dataset_lab\pollution-20260429144708\decisions.csv`
- replay_report_md_path: `E:\dipproj\artifacts\dataset_lab\pollution-20260429144708\summary.md`
