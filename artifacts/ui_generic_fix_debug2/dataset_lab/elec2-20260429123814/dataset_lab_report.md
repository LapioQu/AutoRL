...
- created_at_utc: `2026-04-29T12:38:19.024288+00:00`
- dataset_name: `Elec2`
...
- Adaptive policy `fixed_share_portfolio` finished on strategy `sgd_lr_1_0` after 161 switches.
- It achieved `0.9141` against the best fixed baseline `sgd_lr_0_5` at `0.9160`.
- Oracle upper bound on this stream is `0.9420`. Available oracle gain over best fixed is `0.0259`, and the current adaptive controller captures `0.0%` of it.
- The current stationary portfolio dominated the adaptive controller here; the gap is `-0.0019`.
...
- score_plot_path: `artifacts\ui_generic_fix_debug2\dataset_lab\elec2-20260429123814\dataset_lab_scores.png`
- portfolio_plot_path: `artifacts\ui_generic_fix_debug2\dataset_lab\elec2-20260429123814\dataset_lab_portfolio.png`
- switch_plot_path: `artifacts\ui_generic_fix_debug2\dataset_lab\elec2-20260429123814\dataset_lab_switches.png`

## Artifact Paths

- artifact_root: `artifacts\ui_generic_fix_debug2\dataset_lab\elec2-20260429123814`
- replay_summary_json_path: `E:\dipproj\artifacts\ui_generic_fix_debug2\dataset_lab\elec2-20260429123814\summary.json`
- decision_csv_path: `E:\dipproj\artifacts\ui_generic_fix_debug2\dataset_lab\elec2-20260429123814\decisions.csv`
- replay_report_md_path: `E:\dipproj\artifacts\ui_generic_fix_debug2\dataset_lab\elec2-20260429123814\summary.md`
