...
- created_at_utc: `2026-04-29T12:38:26.697795+00:00`
- dataset_name: `Elec2`
...
- adaptive_score: `0.916159`
- best_fixed_strategy: `sgd_lr_0_5`
- best_fixed_score: `0.916027`
- delta_vs_best_fixed: `+0.000132`
- oracle_score: `0.941958`
- oracle_gain: `0.025931`
- oracle_capture_ratio: `0.51%`
- final_strategy: `sgd_lr_0_5`
- switch_count: `1`

## Interpretation

- Adaptive policy `hard_switch_lcb` finished on strategy `sgd_lr_0_5` after 1 switches.
- It achieved `0.9162` against the best fixed baseline `sgd_lr_0_5` at `0.9160`.
- Oracle upper bound on this stream is `0.9420`. Available oracle gain over best fixed is `0.0259`, and the current adaptive controller captures `0.5%` of it.
...
- score_plot_path: `artifacts\ui_generic_fix_debug2\dataset_lab\elec2-20260429123819\dataset_lab_scores.png`
- portfolio_plot_path: `artifacts\ui_generic_fix_debug2\dataset_lab\elec2-20260429123819\dataset_lab_portfolio.png`
- switch_plot_path: `artifacts\ui_generic_fix_debug2\dataset_lab\elec2-20260429123819\dataset_lab_switches.png`

## Artifact Paths

- artifact_root: `artifacts\ui_generic_fix_debug2\dataset_lab\elec2-20260429123819`
- replay_summary_json_path: `E:\dipproj\artifacts\ui_generic_fix_debug2\dataset_lab\elec2-20260429123819\auto_meta_selection\hard_switch_lcb\summary.json`
- decision_csv_path: `E:\dipproj\artifacts\ui_generic_fix_debug2\dataset_lab\elec2-20260429123819\auto_meta_selection\hard_switch_lcb\decisions.csv`
- replay_report_md_path: `E:\dipproj\artifacts\ui_generic_fix_debug2\dataset_lab\elec2-20260429123819\auto_meta_selection\hard_switch_lcb\summary.md`
