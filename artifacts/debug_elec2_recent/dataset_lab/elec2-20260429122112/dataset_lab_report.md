...
- created_at_utc: `2026-04-29T12:21:34.540539+00:00`
- dataset_name: `Elec2`
...
- adaptive_score: `0.922669`
- best_fixed_strategy: `pa_classifier`
- best_fixed_score: `0.922714`
- delta_vs_best_fixed: `-0.000044`
- oracle_score: `0.978880`
- oracle_gain: `0.056166`
...
- It achieved `0.9227` against the best fixed baseline `pa_classifier` at `0.9227`.
- Oracle upper bound on this stream is `0.9789`. Available oracle gain over best fixed is `0.0562`, and the current adaptive controller captures `0.0%` of it.
- The current stationary portfolio dominated the adaptive controller here; the gap is `-0.0000`.
...
- score_plot_path: `artifacts\debug_elec2_recent\dataset_lab\elec2-20260429122112\dataset_lab_scores.png`
- portfolio_plot_path: `artifacts\debug_elec2_recent\dataset_lab\elec2-20260429122112\dataset_lab_portfolio.png`
- switch_plot_path: `artifacts\debug_elec2_recent\dataset_lab\elec2-20260429122112\dataset_lab_switches.png`

## Artifact Paths

- artifact_root: `artifacts\debug_elec2_recent\dataset_lab\elec2-20260429122112`
- replay_summary_json_path: `E:\dipproj\artifacts\debug_elec2_recent\dataset_lab\elec2-20260429122112\summary.json`
- decision_csv_path: `E:\dipproj\artifacts\debug_elec2_recent\dataset_lab\elec2-20260429122112\decisions.csv`
- replay_report_md_path: `E:\dipproj\artifacts\debug_elec2_recent\dataset_lab\elec2-20260429122112\summary.md`
