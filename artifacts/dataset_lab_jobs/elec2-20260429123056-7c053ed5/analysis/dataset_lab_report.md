...
- created_at_utc: `2026-04-29T12:31:11.920041+00:00`
- dataset_name: `Elec2`
...
- adaptive_score: `0.915343`
- best_fixed_strategy: `sgd_lr_0_5`
- best_fixed_score: `0.916093`
- delta_vs_best_fixed: `-0.000750`
- oracle_score: `0.939442`
- oracle_gain: `0.023349`
...
- Adaptive policy `recent_leader_meta` finished on strategy `sgd_lr_0_5` after 11 switches.
- It achieved `0.9153` against the best fixed baseline `sgd_lr_0_5` at `0.9161`.
- Oracle upper bound on this stream is `0.9394`. Available oracle gain over best fixed is `0.0233`, and the current adaptive controller captures `0.0%` of it.
- The current stationary portfolio dominated the adaptive controller here; the gap is `-0.0008`.
...
- score_plot_path: `artifacts\dataset_lab_jobs\elec2-20260429123056-7c053ed5\analysis\dataset_lab_scores.png`
- portfolio_plot_path: `artifacts\dataset_lab_jobs\elec2-20260429123056-7c053ed5\analysis\dataset_lab_portfolio.png`
- switch_plot_path: `artifacts\dataset_lab_jobs\elec2-20260429123056-7c053ed5\analysis\dataset_lab_switches.png`

## Artifact Paths

- artifact_root: `artifacts\dataset_lab_jobs\elec2-20260429123056-7c053ed5\analysis`
- replay_summary_json_path: `E:\dipproj\artifacts\dataset_lab_jobs\elec2-20260429123056-7c053ed5\analysis\summary.json`
- decision_csv_path: `E:\dipproj\artifacts\dataset_lab_jobs\elec2-20260429123056-7c053ed5\analysis\decisions.csv`
- replay_report_md_path: `E:\dipproj\artifacts\dataset_lab_jobs\elec2-20260429123056-7c053ed5\analysis\summary.md`
