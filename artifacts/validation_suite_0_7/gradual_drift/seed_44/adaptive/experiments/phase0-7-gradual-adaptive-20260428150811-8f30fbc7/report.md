...
| Field | Value |
| --- | --- |
| Experiment ID | phase0-7-gradual-adaptive-20260428150811-8f30fbc7 |
| Experiment Name | phase0-7-gradual-adaptive |
| Status | completed |
| Scenario | gradual_drift |
| Seed | 44 |
| Config Hash | 95ad9a4b0eee0454b028077e2dce06e48514cd074fdac2a843c3925025e1ff44 |
| Artifacts Path | `artifacts\validation_suite_0_7\gradual_drift\seed_44\adaptive\experiments\phase0-7-gradual-adaptive-20260428150811-8f30fbc7` |
...
| Average Reward | 1.043316 |
| Success Rate | 1.000000 |
| Cumulative Reward | 93.898440 |
| Mean Window Variance | 0.001501 |
...
| 4 | switch | fixed_low | fixed_mid | 0.058958 | 0.020000 | switch_advantage |
| 5 | stay | fixed_mid | adaptive_meta_final | -0.007823 | 0.020000 | no_candidate_improvement |
...
meta_controller:
  ...
  utility_weights:
    ...
    compute_cost: 0.08
    switch_cost: 0.2
artifacts_root: artifacts\validation_suite_0_7\gradual_drift\seed_44\adaptive
tags:
- phase_validation
- gradual_drift
notes: null
