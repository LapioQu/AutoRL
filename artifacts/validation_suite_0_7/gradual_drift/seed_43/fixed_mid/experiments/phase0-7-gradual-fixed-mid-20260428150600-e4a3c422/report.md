...
| Field | Value |
| --- | --- |
| Experiment ID | phase0-7-gradual-fixed-mid-20260428150600-e4a3c422 |
| Experiment Name | phase0-7-gradual-fixed_mid |
| Status | completed |
| Scenario | gradual_drift |
| Seed | 43 |
| Config Hash | 4e652967a4752ed1f29d6ac1bf2ba9c3c26ea7f38b43c140fffa214f0a5eac78 |
| Artifacts Path | `artifacts\validation_suite_0_7\gradual_drift\seed_43\fixed_mid\experiments\phase0-7-gradual-fixed-mid-20260428150600-e4a3c422` |
...
| Average Reward | 0.990005 |
| Success Rate | 1.000000 |
| Cumulative Reward | 89.100469 |
| Mean Window Variance | 0.000572 |
...
meta_controller:
  ...
  utility_weights:
    ...
    compute_cost: 0.08
    switch_cost: 0.2
artifacts_root: artifacts\validation_suite_0_7\gradual_drift\seed_43\fixed_mid
tags:
- phase_validation
- gradual_drift
notes: null
