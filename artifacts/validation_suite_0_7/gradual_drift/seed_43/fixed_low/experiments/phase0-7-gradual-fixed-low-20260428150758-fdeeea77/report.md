...
| Field | Value |
| --- | --- |
| Experiment ID | phase0-7-gradual-fixed-low-20260428150758-fdeeea77 |
| Experiment Name | phase0-7-gradual-fixed_low |
| Status | completed |
| Scenario | gradual_drift |
| Seed | 43 |
| Config Hash | 0e351514bd6da7d300aab11498a73c678e1f14cb81c357488a7984341c564eb7 |
| Artifacts Path | `artifacts\validation_suite_0_7\gradual_drift\seed_43\fixed_low\experiments\phase0-7-gradual-fixed-low-20260428150758-fdeeea77` |
...
| Average Reward | 0.746911 |
| Success Rate | 0.544444 |
| Cumulative Reward | 67.221953 |
| Mean Window Variance | 0.000613 |
...
meta_controller:
  ...
  utility_weights:
    ...
    compute_cost: 0.08
    switch_cost: 0.2
artifacts_root: artifacts\validation_suite_0_7\gradual_drift\seed_43\fixed_low
tags:
- phase_validation
- gradual_drift
notes: null
