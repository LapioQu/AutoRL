...
| Field | Value |
| --- | --- |
| Experiment ID | phase0-7-gradual-fixed-high-20260428150748-ddf0575a |
| Experiment Name | phase0-7-gradual-fixed_high |
| Status | completed |
| Scenario | gradual_drift |
| Seed | 42 |
| Config Hash | dff2af07f577412a2d17fb19cf76981fe9164773514ecb0f8afd33441f20da9c |
| Artifacts Path | `artifacts\validation_suite_0_7\gradual_drift\seed_42\fixed_high\experiments\phase0-7-gradual-fixed-high-20260428150748-ddf0575a` |
...
| Average Reward | 0.718291 |
| Success Rate | 0.522222 |
| Cumulative Reward | 64.646232 |
| Mean Window Variance | 0.000567 |
...
meta_controller:
  ...
  utility_weights:
    ...
    compute_cost: 0.08
    switch_cost: 0.2
artifacts_root: artifacts\validation_suite_0_7\gradual_drift\seed_42\fixed_high
tags:
- phase_validation
- gradual_drift
notes: null
