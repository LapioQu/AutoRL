...
| Field | Value |
| --- | --- |
| Experiment ID | phase0-7-gradual-fixed-mid-20260428150745-fb237486 |
| Experiment Name | phase0-7-gradual-fixed_mid |
| Status | completed |
| Scenario | gradual_drift |
| Seed | 42 |
| Config Hash | ea1fc212241dafae2dd5bf1bc78d661468c6318ef1e688ace2f55fb8020a3eb8 |
| Artifacts Path | `artifacts\validation_suite_0_7\gradual_drift\seed_42\fixed_mid\experiments\phase0-7-gradual-fixed-mid-20260428150745-fb237486` |
...
| Average Reward | 0.990134 |
| Success Rate | 1.000000 |
| Cumulative Reward | 89.112103 |
| Mean Window Variance | 0.000568 |
...
meta_controller:
  ...
  utility_weights:
    ...
    compute_cost: 0.08
    switch_cost: 0.2
artifacts_root: artifacts\validation_suite_0_7\gradual_drift\seed_42\fixed_mid
tags:
- phase_validation
- gradual_drift
notes: null
