...
| Field | Value |
| --- | --- |
| Experiment ID | phase0-7-gradual-adaptive-20260428150530-5e9db62c |
| Experiment Name | phase0-7-gradual-adaptive |
| Status | completed |
| Scenario | gradual_drift |
| Seed | 42 |
| Config Hash | 21b09be8390f1385462f415e8a503ae0769a09898f57c59f474401fd233225a2 |
| Artifacts Path | `artifacts\validation_suite_0_7\gradual_drift\seed_42\adaptive\experiments\phase0-7-gradual-adaptive-20260428150530-5e9db62c` |
...
| Decisions | 83 |
| Switches | 2 |
| Fallback Decisions | 27 |
| Average Reward | 1.040287 |
| Success Rate | 1.000000 |
| Cumulative Reward | 93.625806 |
| Mean Window Variance | 0.001585 |
...
meta_controller:
  ...
  utility_weights:
    ...
    compute_cost: 0.08
    switch_cost: 0.2
artifacts_root: artifacts\validation_suite_0_7\gradual_drift\seed_42\adaptive
tags:
- phase_validation
- gradual_drift
notes: null
