...
| Field | Value |
| --- | --- |
| Experiment ID | phase0-7-gradual-fixed-mid-20260428150728-b4813654 |
| Experiment Name | phase0-7-gradual-fixed_mid |
| Status | completed |
| Scenario | gradual_drift |
| Seed | 41 |
| Config Hash | 258aed40aaf8a89d5ae8bff5c234ebf6764783e680203b3fee9696150e56352e |
| Artifacts Path | `artifacts\validation_suite_0_7\gradual_drift\seed_41\fixed_mid\experiments\phase0-7-gradual-fixed-mid-20260428150728-b4813654` |
...
| Average Reward | 0.990422 |
| Success Rate | 1.000000 |
| Cumulative Reward | 89.137961 |
...
meta_controller:
  ...
  utility_weights:
    ...
    compute_cost: 0.08
    switch_cost: 0.2
artifacts_root: artifacts\validation_suite_0_7\gradual_drift\seed_41\fixed_mid
tags:
- phase_validation
- gradual_drift
notes: null
