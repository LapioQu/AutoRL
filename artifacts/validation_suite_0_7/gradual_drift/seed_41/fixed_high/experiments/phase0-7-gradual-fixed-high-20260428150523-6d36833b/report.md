...
| Field | Value |
| --- | --- |
| Experiment ID | phase0-7-gradual-fixed-high-20260428150523-6d36833b |
| Experiment Name | phase0-7-gradual-fixed_high |
| Status | completed |
| Scenario | gradual_drift |
| Seed | 41 |
| Config Hash | b7f20d5cec5554698c09bcc2305536a1110f73e406a8219862562465b413640c |
| Artifacts Path | `artifacts\validation_suite_0_7\gradual_drift\seed_41\fixed_high\experiments\phase0-7-gradual-fixed-high-20260428150523-6d36833b` |
...
| Average Reward | 0.718529 |
| Success Rate | 0.522222 |
| Cumulative Reward | 64.667589 |
| Mean Window Variance | 0.000574 |
...
meta_controller:
  ...
  utility_weights:
    ...
    compute_cost: 0.08
    switch_cost: 0.2
artifacts_root: artifacts\validation_suite_0_7\gradual_drift\seed_41\fixed_high
tags:
- phase_validation
- gradual_drift
notes: null
