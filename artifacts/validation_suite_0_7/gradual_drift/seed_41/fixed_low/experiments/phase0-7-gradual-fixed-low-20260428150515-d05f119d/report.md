...
| Field | Value |
| --- | --- |
| Experiment ID | phase0-7-gradual-fixed-low-20260428150515-d05f119d |
| Experiment Name | phase0-7-gradual-fixed_low |
| Status | completed |
| Scenario | gradual_drift |
| Seed | 41 |
| Config Hash | 5994651a7f97312cfaac84d6aa8c7e56a188ccfa21460e62757fa4e16ed32eef |
| Artifacts Path | `artifacts\validation_suite_0_7\gradual_drift\seed_41\fixed_low\experiments\phase0-7-gradual-fixed-low-20260428150515-d05f119d` |
...
| Average Reward | 0.747331 |
| Success Rate | 0.544444 |
| Cumulative Reward | 67.259766 |
...
meta_controller:
  ...
  utility_weights:
    ...
    compute_cost: 0.08
    switch_cost: 0.2
artifacts_root: artifacts\validation_suite_0_7\gradual_drift\seed_41\fixed_low
tags:
- phase_validation
- gradual_drift
notes: null
