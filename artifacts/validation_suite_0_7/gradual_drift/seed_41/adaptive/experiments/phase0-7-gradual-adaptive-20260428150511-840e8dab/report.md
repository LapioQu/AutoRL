...
| Field | Value |
| --- | --- |
| Experiment ID | phase0-7-gradual-adaptive-20260428150511-840e8dab |
| Experiment Name | phase0-7-gradual-adaptive |
| Status | completed |
| Scenario | gradual_drift |
| Seed | 41 |
| Config Hash | d46d81f977f74b92ca4f7c9cb373c6137bd8d51c2e24cb4e8d2f93e1911e369e |
| Artifacts Path | `artifacts\validation_suite_0_7\gradual_drift\seed_41\adaptive\experiments\phase0-7-gradual-adaptive-20260428150511-840e8dab` |
...
| Average Reward | 1.043376 |
| Success Rate | 1.000000 |
| Cumulative Reward | 93.903867 |
| Mean Window Variance | 0.001510 |
...
| 4 | switch | fixed_low | fixed_mid | 0.058961 | 0.020000 | switch_advantage |
| 5 | stay | fixed_mid | adaptive_meta_final | -0.007822 | 0.020000 | no_candidate_improvement |
...
meta_controller:
  ...
  utility_weights:
    ...
    compute_cost: 0.08
    switch_cost: 0.2
artifacts_root: artifacts\validation_suite_0_7\gradual_drift\seed_41\adaptive
tags:
- phase_validation
- gradual_drift
notes: null
