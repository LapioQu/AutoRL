...
| Field | Value |
| --- | --- |
| Experiment ID | phase0-7-gradual-fixed-high-20260428150655-6add5717 |
| Experiment Name | phase0-7-gradual-fixed_high |
| Status | completed |
| Scenario | gradual_drift |
| Seed | 45 |
| Config Hash | 9819ab54017933fcb0f2b996b0cfcb48d9e8825e6c9a9a2cb20ca0393d4776eb |
| Artifacts Path | `artifacts\validation_suite_0_7\gradual_drift\seed_45\fixed_high\experiments\phase0-7-gradual-fixed-high-20260428150655-6add5717` |
...
| Average Reward | 0.718325 |
| Success Rate | 0.522222 |
| Cumulative Reward | 64.649218 |
...
meta_controller:
  ...
  utility_weights:
    ...
    compute_cost: 0.08
    switch_cost: 0.2
artifacts_root: artifacts\validation_suite_0_7\gradual_drift\seed_45\fixed_high
tags:
- phase_validation
- gradual_drift
notes: null
