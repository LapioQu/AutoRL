...
| Field | Value |
| --- | --- |
| Experiment ID | phase0-7-gradual-fixed-mid-20260428150834-36e181a2 |
| Experiment Name | phase0-7-gradual-fixed_mid |
| Status | completed |
| Scenario | gradual_drift |
| Seed | 45 |
| Config Hash | cfdfd7a80fe44e32ed1d513affaa24213bd1d907a928cd873b18a4a69d7dd8a6 |
| Artifacts Path | `artifacts\validation_suite_0_7\gradual_drift\seed_45\fixed_mid\experiments\phase0-7-gradual-fixed-mid-20260428150834-36e181a2` |
...
| Average Reward | 0.990239 |
| Success Rate | 1.000000 |
| Cumulative Reward | 89.121492 |
...
meta_controller:
  ...
  utility_weights:
    ...
    compute_cost: 0.08
    switch_cost: 0.2
artifacts_root: artifacts\validation_suite_0_7\gradual_drift\seed_45\fixed_mid
tags:
- phase_validation
- gradual_drift
notes: null
