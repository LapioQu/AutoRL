...
| Field | Value |
| --- | --- |
| Experiment ID | phase0-7-gradual-fixed-low-20260428150830-daf89815 |
| Experiment Name | phase0-7-gradual-fixed_low |
| Status | completed |
| Scenario | gradual_drift |
| Seed | 45 |
| Config Hash | e63c671eef36c42f14838e182eb6728482ab7d394067fbae226395906b9a45aa |
| Artifacts Path | `artifacts\validation_suite_0_7\gradual_drift\seed_45\fixed_low\experiments\phase0-7-gradual-fixed-low-20260428150830-daf89815` |
...
| Average Reward | 0.747147 |
| Success Rate | 0.544444 |
| Cumulative Reward | 67.243194 |
...
meta_controller:
  ...
  utility_weights:
    ...
    compute_cost: 0.08
    switch_cost: 0.2
artifacts_root: artifacts\validation_suite_0_7\gradual_drift\seed_45\fixed_low
tags:
- phase_validation
- gradual_drift
notes: null
