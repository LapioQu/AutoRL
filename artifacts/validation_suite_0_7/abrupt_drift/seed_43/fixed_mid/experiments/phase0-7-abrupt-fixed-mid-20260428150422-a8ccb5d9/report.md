...
| Field | Value |
| --- | --- |
| Experiment ID | phase0-7-abrupt-fixed-mid-20260428150422-a8ccb5d9 |
| Experiment Name | phase0-7-abrupt-fixed_mid |
| Status | completed |
| Scenario | abrupt_drift |
| Seed | 43 |
| Config Hash | 445041661650d6ad003f938241b91a12938934632c6a2d414f306088731326df |
| Artifacts Path | `artifacts\validation_suite_0_7\abrupt_drift\seed_43\fixed_mid\experiments\phase0-7-abrupt-fixed-mid-20260428150422-a8ccb5d9` |
...
| Average Reward | 0.942021 |
| Success Rate | 1.000000 |
| Cumulative Reward | 75.361661 |
| Mean Window Variance | 0.001760 |
...
meta_controller:
  ...
  utility_weights:
    ...
    compute_cost: 0.08
    switch_cost: 0.2
artifacts_root: artifacts\validation_suite_0_7\abrupt_drift\seed_43\fixed_mid
tags:
- phase_validation
- abrupt_drift
notes: null
