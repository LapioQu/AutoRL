...
| Field | Value |
| --- | --- |
| Experiment ID | phase0-7-abrupt-fixed-low-20260428150456-93b3f820 |
| Experiment Name | phase0-7-abrupt-fixed_low |
| Status | completed |
| Scenario | abrupt_drift |
| Seed | 45 |
| Config Hash | c3d4dff1ecf5746612f27eaeec16f52d636bba93d8089d7a07450a8709f678e2 |
| Artifacts Path | `artifacts\validation_suite_0_7\abrupt_drift\seed_45\fixed_low\experiments\phase0-7-abrupt-fixed-low-20260428150456-93b3f820` |
...
| Average Reward | 0.744760 |
| Success Rate | 0.500000 |
| Cumulative Reward | 59.580796 |
| Mean Window Variance | 0.005010 |
...
meta_controller:
  ...
  utility_weights:
    ...
    compute_cost: 0.08
    switch_cost: 0.2
artifacts_root: artifacts\validation_suite_0_7\abrupt_drift\seed_45\fixed_low
tags:
- phase_validation
- abrupt_drift
notes: null
