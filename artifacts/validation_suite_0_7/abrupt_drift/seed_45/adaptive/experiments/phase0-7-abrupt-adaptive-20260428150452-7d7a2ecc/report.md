...
| Field | Value |
| --- | --- |
| Experiment ID | phase0-7-abrupt-adaptive-20260428150452-7d7a2ecc |
| Experiment Name | phase0-7-abrupt-adaptive |
| Status | completed |
| Scenario | abrupt_drift |
| Seed | 45 |
| Config Hash | ddf05131abdb2ffcf5a6bb7211bc69c898cf70dc0804bb3fa724c676a6ad443c |
| Artifacts Path | `artifacts\validation_suite_0_7\abrupt_drift\seed_45\adaptive\experiments\phase0-7-abrupt-adaptive-20260428150452-7d7a2ecc` |
...
| Average Reward | 1.021129 |
| Success Rate | 1.000000 |
| Cumulative Reward | 81.690297 |
| Mean Window Variance | 0.002931 |
...
meta_controller:
  ...
  utility_weights:
    ...
    compute_cost: 0.08
    switch_cost: 0.2
artifacts_root: artifacts\validation_suite_0_7\abrupt_drift\seed_45\adaptive
tags:
- phase_validation
- abrupt_drift
notes: null
