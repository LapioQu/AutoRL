...
| Field | Value |
| --- | --- |
| Experiment ID | phase0-7-abrupt-adaptive-20260428150545-b1c23b63 |
| Experiment Name | phase0-7-abrupt-adaptive |
| Status | completed |
| Scenario | abrupt_drift |
| Seed | 41 |
| Config Hash | 22f8bdbd88415c8c88073b475c14733ad95e5629a9f61af3700828d97836ea9c |
| Artifacts Path | `artifacts\validation_suite_0_7\abrupt_drift\seed_41\adaptive\experiments\phase0-7-abrupt-adaptive-20260428150545-b1c23b63` |
...
| Average Reward | 1.021618 |
| Success Rate | 1.000000 |
| Cumulative Reward | 81.729418 |
| Mean Window Variance | 0.002932 |
...
meta_controller:
  ...
  utility_weights:
    ...
    compute_cost: 0.08
    switch_cost: 0.2
artifacts_root: artifacts\validation_suite_0_7\abrupt_drift\seed_41\adaptive
tags:
- phase_validation
- abrupt_drift
notes: null
