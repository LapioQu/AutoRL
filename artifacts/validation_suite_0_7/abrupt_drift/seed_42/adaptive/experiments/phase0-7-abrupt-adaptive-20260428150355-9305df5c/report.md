...
| Field | Value |
| --- | --- |
| Experiment ID | phase0-7-abrupt-adaptive-20260428150355-9305df5c |
| Experiment Name | phase0-7-abrupt-adaptive |
| Status | completed |
| Scenario | abrupt_drift |
| Seed | 42 |
| Config Hash | 0d10f88674c2fa471502b245ef546481d91a988751c4de61e9dd6dc2554aa03d |
| Artifacts Path | `artifacts\validation_suite_0_7\abrupt_drift\seed_42\adaptive\experiments\phase0-7-abrupt-adaptive-20260428150355-9305df5c` |
...
| Average Reward | 1.021256 |
| Success Rate | 1.000000 |
| Cumulative Reward | 81.700502 |
| Mean Window Variance | 0.002965 |
...
meta_controller:
  ...
  utility_weights:
    ...
    compute_cost: 0.08
    switch_cost: 0.2
artifacts_root: artifacts\validation_suite_0_7\abrupt_drift\seed_42\adaptive
tags:
- phase_validation
- abrupt_drift
notes: null
