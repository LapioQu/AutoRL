...
| Field | Value |
| --- | --- |
| Experiment ID | phase0-7-abrupt-fixed-mid-20260428150403-a01a24bc |
| Experiment Name | phase0-7-abrupt-fixed_mid |
| Status | completed |
| Scenario | abrupt_drift |
| Seed | 42 |
| Config Hash | fdc7de97a555d48287bc1e85cc8074f26d1fa1cc9505f7a32c1a3ea8fa775349 |
| Artifacts Path | `artifacts\validation_suite_0_7\abrupt_drift\seed_42\fixed_mid\experiments\phase0-7-abrupt-fixed-mid-20260428150403-a01a24bc` |
...
meta_controller:
  ...
  utility_weights:
    ...
    compute_cost: 0.08
    switch_cost: 0.2
artifacts_root: artifacts\validation_suite_0_7\abrupt_drift\seed_42\fixed_mid
tags:
- phase_validation
- abrupt_drift
notes: null
