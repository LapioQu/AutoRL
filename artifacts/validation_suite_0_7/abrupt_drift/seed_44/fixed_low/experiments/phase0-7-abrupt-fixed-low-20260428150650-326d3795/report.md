...
| Field | Value |
| --- | --- |
| Experiment ID | phase0-7-abrupt-fixed-low-20260428150650-326d3795 |
| Experiment Name | phase0-7-abrupt-fixed_low |
| Status | completed |
| Scenario | abrupt_drift |
| Seed | 44 |
| Config Hash | 05568743abe967ce67bb5c8a06f2f0fc99cd9345414b3c545eb80d4074982bb0 |
| Artifacts Path | `artifacts\validation_suite_0_7\abrupt_drift\seed_44\fixed_low\experiments\phase0-7-abrupt-fixed-low-20260428150650-326d3795` |
...
| Average Reward | 0.745204 |
| Success Rate | 0.500000 |
| Cumulative Reward | 59.616342 |
| Mean Window Variance | 0.005050 |
...
meta_controller:
  ...
  utility_weights:
    ...
    compute_cost: 0.08
    switch_cost: 0.2
artifacts_root: artifacts\validation_suite_0_7\abrupt_drift\seed_44\fixed_low
tags:
- phase_validation
- abrupt_drift
notes: null
