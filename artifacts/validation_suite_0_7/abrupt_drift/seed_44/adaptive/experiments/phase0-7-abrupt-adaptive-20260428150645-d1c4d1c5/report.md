...
| Field | Value |
| --- | --- |
| Experiment ID | phase0-7-abrupt-adaptive-20260428150645-d1c4d1c5 |
| Experiment Name | phase0-7-abrupt-adaptive |
| Status | completed |
| Scenario | abrupt_drift |
| Seed | 44 |
| Config Hash | f02d06a12e9a05f81cbf6041a2bafed9b312f699a397d3b7bb520e4e9d505ae9 |
| Artifacts Path | `artifacts\validation_suite_0_7\abrupt_drift\seed_44\adaptive\experiments\phase0-7-abrupt-adaptive-20260428150645-d1c4d1c5` |
...
| Average Reward | 1.021573 |
| Success Rate | 1.000000 |
| Cumulative Reward | 81.725843 |
| Mean Window Variance | 0.002944 |
...
meta_controller:
  ...
  utility_weights:
    ...
    compute_cost: 0.08
    switch_cost: 0.2
artifacts_root: artifacts\validation_suite_0_7\abrupt_drift\seed_44\adaptive
tags:
- phase_validation
- abrupt_drift
notes: null
