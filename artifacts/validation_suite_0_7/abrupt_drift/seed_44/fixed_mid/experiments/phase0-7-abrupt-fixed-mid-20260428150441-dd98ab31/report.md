...
| Field | Value |
| --- | --- |
| Experiment ID | phase0-7-abrupt-fixed-mid-20260428150441-dd98ab31 |
| Experiment Name | phase0-7-abrupt-fixed_mid |
| Status | completed |
| Scenario | abrupt_drift |
| Seed | 44 |
| Config Hash | 72057440f2ff1f37c65cea2fbc87f89b3a8dbdcf1aef0592caf760dfdfec07a8 |
| Artifacts Path | `artifacts\validation_suite_0_7\abrupt_drift\seed_44\fixed_mid\experiments\phase0-7-abrupt-fixed-mid-20260428150441-dd98ab31` |
...
| Average Reward | 0.942546 |
| Success Rate | 1.000000 |
| Cumulative Reward | 75.403646 |
| Mean Window Variance | 0.001744 |
...
meta_controller:
  ...
  utility_weights:
    ...
    compute_cost: 0.08
    switch_cost: 0.2
artifacts_root: artifacts\validation_suite_0_7\abrupt_drift\seed_44\fixed_mid
tags:
- phase_validation
- abrupt_drift
notes: null
