...
- created_at_utc: `2026-04-29T15:13:29.293477+00:00`
- dataset_name: `pollution_2000`
...
- adaptive_score: `0.839362`
- best_fixed_strategy: `lin_lr_0_002`
- best_fixed_score: `0.837381`
- delta_vs_best_fixed: `+0.001980`
- oracle_score: `0.917683`
- oracle_gain: `0.080302`
- oracle_capture_ratio: `2.47%`
- final_strategy: `lin_lr_0_002`
- switch_count: `16`

## Interpretation

- Adaptive policy `fixed_share_portfolio` finished on strategy `lin_lr_0_002` after 16 switches.
- It achieved `0.8394` against the best fixed baseline `lin_lr_0_002` at `0.8374`.
- Oracle upper bound on this stream is `0.9177`. Available oracle gain over best fixed is `0.0803`, and the current adaptive controller captures `2.5%` of it.
- The uploaded stream looks non-stationary enough for adaptation to help: the gain over best fixed is `0.0020`.
...
- score_plot_path: `artifacts\tmp_eval\dataset_lab\pollution-2000-20260429151320\dataset_lab_scores.png`
- portfolio_plot_path: `artifacts\tmp_eval\dataset_lab\pollution-2000-20260429151320\dataset_lab_portfolio.png`
- switch_plot_path: `artifacts\tmp_eval\dataset_lab\pollution-2000-20260429151320\dataset_lab_switches.png`

## Artifact Paths

- artifact_root: `artifacts\tmp_eval\dataset_lab\pollution-2000-20260429151320`
- replay_summary_json_path: `E:\dipproj\artifacts\tmp_eval\dataset_lab\pollution-2000-20260429151320\auto_meta_selection\fixed_share_portfolio\summary.json`
- decision_csv_path: `E:\dipproj\artifacts\tmp_eval\dataset_lab\pollution-2000-20260429151320\auto_meta_selection\fixed_share_portfolio\decisions.csv`
- replay_report_md_path: `E:\dipproj\artifacts\tmp_eval\dataset_lab\pollution-2000-20260429151320\auto_meta_selection\fixed_share_portfolio\summary.md`
