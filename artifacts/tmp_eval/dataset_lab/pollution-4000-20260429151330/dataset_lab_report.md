...
- created_at_utc: `2026-04-29T15:13:47.496598+00:00`
- dataset_name: `pollution_4000`
...
- prediction_confidence: `0.1667` (low)

## Comparative Metrics

- adaptive_score: `0.839908`
- best_fixed_strategy: `lin_lr_0_002`
- best_fixed_score: `0.838480`
- delta_vs_best_fixed: `+0.001428`
- oracle_score: `0.907154`
- oracle_gain: `0.068674`
- oracle_capture_ratio: `2.08%`
- final_strategy: `lin_lr_0_002`
- switch_count: `23`

## Interpretation

- Adaptive policy `fixed_share_portfolio` finished on strategy `lin_lr_0_002` after 23 switches.
- It achieved `0.8399` against the best fixed baseline `lin_lr_0_002` at `0.8385`.
- Oracle upper bound on this stream is `0.9072`. Available oracle gain over best fixed is `0.0687`, and the current adaptive controller captures `2.1%` of it.
- The uploaded stream looks non-stationary enough for adaptation to help: the gain over best fixed is `0.0014`.
...
- score_plot_path: `artifacts\tmp_eval\dataset_lab\pollution-4000-20260429151330\dataset_lab_scores.png`
- portfolio_plot_path: `artifacts\tmp_eval\dataset_lab\pollution-4000-20260429151330\dataset_lab_portfolio.png`
- switch_plot_path: `artifacts\tmp_eval\dataset_lab\pollution-4000-20260429151330\dataset_lab_switches.png`

## Artifact Paths

- artifact_root: `artifacts\tmp_eval\dataset_lab\pollution-4000-20260429151330`
- replay_summary_json_path: `E:\dipproj\artifacts\tmp_eval\dataset_lab\pollution-4000-20260429151330\auto_meta_selection\fixed_share_portfolio\summary.json`
- decision_csv_path: `E:\dipproj\artifacts\tmp_eval\dataset_lab\pollution-4000-20260429151330\auto_meta_selection\fixed_share_portfolio\decisions.csv`
- replay_report_md_path: `E:\dipproj\artifacts\tmp_eval\dataset_lab\pollution-4000-20260429151330\auto_meta_selection\fixed_share_portfolio\summary.md`
