...
- created_at_utc: `2026-04-29T15:11:21.677982+00:00`
- dataset_name: `Elec2`
...
- adaptive_score: `0.940250`
- best_fixed_strategy: `pa_classifier`
- best_fixed_score: `0.948250`
- delta_vs_best_fixed: `-0.008000`
- oracle_score: `0.984000`
- oracle_gain: `0.035750`
...
- Adaptive policy `fixed_share_portfolio` finished on strategy `pa_classifier` after 7 switches.
- It achieved `0.9403` against the best fixed baseline `pa_classifier` at `0.9483`.
- Oracle upper bound on this stream is `0.9840`. Available oracle gain over best fixed is `0.0357`, and the current adaptive controller captures `0.0%` of it.
- The current stationary portfolio dominated the adaptive controller here; the gap is `-0.0080`.
...
- score_plot_path: `artifacts\tmp_eval\dataset_lab\elec2-20260429151111\dataset_lab_scores.png`
- portfolio_plot_path: `artifacts\tmp_eval\dataset_lab\elec2-20260429151111\dataset_lab_portfolio.png`
- switch_plot_path: `artifacts\tmp_eval\dataset_lab\elec2-20260429151111\dataset_lab_switches.png`

## Artifact Paths

- artifact_root: `artifacts\tmp_eval\dataset_lab\elec2-20260429151111`
- replay_summary_json_path: `E:\dipproj\artifacts\tmp_eval\dataset_lab\elec2-20260429151111\summary.json`
- decision_csv_path: `E:\dipproj\artifacts\tmp_eval\dataset_lab\elec2-20260429151111\decisions.csv`
- replay_report_md_path: `E:\dipproj\artifacts\tmp_eval\dataset_lab\elec2-20260429151111\summary.md`
