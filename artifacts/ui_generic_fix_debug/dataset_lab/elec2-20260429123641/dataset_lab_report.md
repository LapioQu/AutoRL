...
- created_at_utc: `2026-04-29T12:36:47.487954+00:00`
- dataset_name: `Elec2`
...
- Adaptive policy `fixed_share_portfolio` finished on strategy `sgd_lr_0_5` after 172 switches.
- It achieved `0.9147` against the best fixed baseline `sgd_lr_0_5` at `0.9161`.
...
- The current stationary portfolio dominated the adaptive controller here; the gap is `-0.0014`.
...
- score_plot_path: `artifacts\ui_generic_fix_debug\dataset_lab\elec2-20260429123641\dataset_lab_scores.png`
- portfolio_plot_path: `artifacts\ui_generic_fix_debug\dataset_lab\elec2-20260429123641\dataset_lab_portfolio.png`
- switch_plot_path: `artifacts\ui_generic_fix_debug\dataset_lab\elec2-20260429123641\dataset_lab_switches.png`

## Artifact Paths

- artifact_root: `artifacts\ui_generic_fix_debug\dataset_lab\elec2-20260429123641`
- replay_summary_json_path: `E:\dipproj\artifacts\ui_generic_fix_debug\dataset_lab\elec2-20260429123641\summary.json`
- decision_csv_path: `E:\dipproj\artifacts\ui_generic_fix_debug\dataset_lab\elec2-20260429123641\decisions.csv`
- replay_report_md_path: `E:\dipproj\artifacts\ui_generic_fix_debug\dataset_lab\elec2-20260429123641\summary.md`
